...
class ElasticsearchUtils(object):
    def __init__(self, hostname: str, port: int) -> None:
        self.es = Elasticsearch(host="192.168.88.123", port=9200)
...
def evtx2es(filepath: str, host: str = '192.168.88.123', port: int = 9200, index: str = 'evtx2es', type: str = 'evtx2es', size: int = 500):
...
def main():
    ...
    parser.add_argument('--host', default='192.168.88.123', help='ElasticSearch host address')
