...
argparser.add_argument("--elasticsearch", "-e", default="http://192.168.88.123:9200", help="URL of Elasticsearch instance (%(default)s)")
...
es = Elasticsearch(host="192.168.88.123", port=9200)
